...
class DaoTests {
	...
	/*@Test
	void agentziaBerriTTest() {
		Agentzia ag = new Agentzia("Javi", "foto", "#FFFFFF", "L1", "A1", "xx", "zz");
		metodoak.agentziaberri(ag);
		assertFalse(metodoak.saioaKonprobatu("xx", "zz"));
	}*/

	@Test
	void agentziaBerriFTest() {
		Agentzia ag = new Agentzia(1, "Javi", "foto", "#FFFFFF", "L1", "A1", "qweqwe", "qweqwe");
		metodoak.agentziaberri(ag);
	...
	/*@Test
	void agentziaMotaBilatuTTest() {
		assertEquals(metodoak.agentziaMotaBilatu(1), "A1");
	}*/

	/*@Test
	void koloreaHartuTest() {
		Agentzia ag = new Agentzia("Javi", "foto", "#FFFFFF", "L1", "A1", "qweqwe", "qweqwe");
		assertEquals(metodoak.koloreaHartu(ag), "#FFFFFF");
	}*/

	/*@Test
	void agentziaKargatuBDTest() {
		Agentzia ag = new Agentzia(14, "TestAgKargatu", "foto", "#FFFFFF", "L1", "A1", "test", "test");
		metodoak.agentziaberri(ag);
	...
	void bidaiKargatuBDTest() {
		...
		bidaia.add(b1);
		assertEquals(metodoak.bidaiKargatuDB(ag), b1);
	}*/

	/*@Test
	void agentziaatuBDTest() {
		Agentzia ag = new Agentzia(14, "TestAgKargatu", "foto", "#FFFFFF", "L1", "A1", "test", "test");
		Bidai b1 = new Bidai(1, "b1test", 1, "test bidaia", "zerbez", "testmota", "hasidata", "amaidata", "helmuga");
		metodoak.agentziaberri(ag);
		assertTrue(metodoak.bidaiGordeDB(ag, b1));
